...
class ViewController: UIViewController, CLLocationManagerDelegate {
    ...
    private let introBtn = UIButton()
    private var currentPosBtn = UIButton()
    private var deletePinsBtn = UIButton(), deleteAllPinsBtn = UIButton()
    private var settingBtn = UIButton()
    private var hideTableBtn = UIButton(), hidePanelBtn = UIButton()
    private var deletePinBtn = UIButton()
    private var modifyPinBtn = UIButton()
    private var panel1 = UIView(), panel2 = UIView()
    ...
    private let pinheight = 32, pinwidth = 24
    
    private var pincount = 0
    private var pininfoDisplayed = false
    private var isExistingPin = false
